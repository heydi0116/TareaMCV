...
public class addActivity extends AppCompatActivity {
    EditText nombres, apellidos, edad, direccion, puestos;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puestos =(EditText) findViewById(R.id.txtPuesto);
    ...
    private void AgregarPersonas(){
        ...
        valores.put(Transacciones.puesto , puestos.getText().toString());
